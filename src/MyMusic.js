    ...
    return (
      <div style={styles.myMusicContainer}>
        ...
        <div style={styles.info}>
          <img
            style={styles.image}
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSq-njXzoSDACixKu46yNLnbmuDFsfO17igjjUNnreH1v6BsXgNmGHidrM_yxJgMrEGAcE&usqp=CAU"
          ></img>
          <div style={styles.subInfo}>
            <h4 style={{ marginBottom: "0.5rem" }}>On My Way</h4>
            <p style={{ marginBottom: "0" }}>
              Alan Walker , Farruko , Sabrina Carpenter
            </p>
          </div>
        </div>
